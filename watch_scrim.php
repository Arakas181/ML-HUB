...
try {
    $stmt = $pdo->prepare("
        ...
        WHERE v.category = 'scrim' $searchCondition
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_video']) && ($userRole === 'admin' || $userRole === 'super_admin')) {
    ...
    if (!empty($title) && !empty($video_url)) {
        try {
            $stmt = $pdo->prepare("INSERT INTO videos (title, description, video_url, category, status, uploaded_by) VALUES (?, ?, ?, 'scrim', ?, ?)");
            $stmt->execute([$title, $description, $video_url, $status, $_SESSION['user_id']]);
            header('Location: watch_scrim.php');
            exit();
        } catch (PDOException $e) {
...
<head>
    ...
    <title>Watch Scrim - ML HUB</title>
...
<body>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="watch_scrim.php">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="text-center mb-4">
                        <i class="fas fa-sword me-3"></i>Scrim Matches
                    </h1>
                    <form method="GET" class="d-flex gap-3">
                        <input type="text" name="search" class="form-control search-box" 
                               placeholder="Search scrim matches..." value="<?php echo htmlspecialchars($searchTerm); ?>">
    ...
    <div class="container my-5">
        ...
        <div class="admin-controls">
            <h4><i class="fas fa-plus-circle me-2"></i>Add New Scrim Match</h4>
            <form method="POST" class="row g-3">
                <div class="col-md-6">
                    <input type="text" name="title" class="form-control" placeholder="Scrim Title (e.g., Squad A vs Squad B)" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    <textarea name="description" class="form-control" rows="2" placeholder="Scrim Description"></textarea>
                </div>
                <div class="col-12">
                    <button type="submit" name="add_video" class="btn btn-light">
                        <i class="fas fa-plus me-2"></i>Add Scrim
                    </button>
                </div>
            </form>
        </div>
        ...
        <div class="row">
            <?php if (empty($videos)): ?>
                <div class="col-12 text-center py-5">
                    ...
                    <h4 class="text-muted">No scrim matches found</h4>
                    <p class="text-muted">
                        <?php if (!empty($searchTerm)): ?>
                            Try adjusting your search terms.
                        <?php else: ?>
                            Check back later for new scrims!
                        <?php endif; ?>
                    </p>
                </div>
            <?php else: ?>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card video-card h-100">
                        <div class="video-thumbnail">
                            ...
                            <?php endif; ?>
                            <div class="scrim-badge">
                                <i class="fas fa-sword me-1"></i>SCRIM
                            </div>
    ...
    <script>
        // Initialize chat for scrim page
