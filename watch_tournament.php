...
try {
    $stmt = $pdo->prepare("
        ...
        WHERE v.category = 'tournament' $searchCondition
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_video']) && ($userRole === 'admin' || $userRole === 'super_admin')) {
    ...
    if (!empty($title) && !empty($video_url)) {
        try {
            $stmt = $pdo->prepare("INSERT INTO videos (title, description, video_url, category, status, uploaded_by) VALUES (?, ?, ?, 'tournament', ?, ?)");
            $stmt->execute([$title, $description, $video_url, $status, $_SESSION['user_id']]);
            header('Location: watch_tournament.php');
            exit();
        } catch (PDOException $e) {
...
<head>
    ...
    <title>Watch Tournament - ML HUB</title>
...
<body>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="watch_tournament.php">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="text-center mb-4">
                        <i class="fas fa-crown me-3"></i>Tournament Videos
                    </h1>
                    <form method="GET" class="d-flex gap-3">
                        <input type="text" name="search" class="form-control search-box" 
                               placeholder="Search tournament videos..." value="<?php echo htmlspecialchars($searchTerm); ?>">
    ...
    <div class="container my-5">
        ...
        <div class="admin-controls">
            <h4><i class="fas fa-plus-circle me-2"></i>Add New Tournament Video</h4>
            <form method="POST" class="row g-3">
                <div class="col-md-6">
                    <input type="text" name="title" class="form-control" placeholder="Tournament Title" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    <textarea name="description" class="form-control" rows="2" placeholder="Tournament Description"></textarea>
                </div>
                <div class="col-12">
        ...
        <div class="row">
            <?php if (empty($videos)): ?>
                <div class="col-12 text-center py-5">
                    ...
                    <h4 class="text-muted">No tournament videos found</h4>
                    <p class="text-muted">
                    ...
                    <div class="card video-card h-100">
                        <div class="video-thumbnail">
                            ...
                            <div class="tournament-badge">
                                <i class="fas fa-crown me-1"></i>TOURNAMENT
                            </div>
    ...
    <script>
        // Initialize chat for tournament page
