...
try {
    $stmt = $pdo->prepare("
        ...
        WHERE v.category = 'live_stream' $searchCondition
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_video']) && ($userRole === 'admin' || $userRole === 'super_admin')) {
    ...
    if (!empty($title) && !empty($video_url)) {
        try {
            $stmt = $pdo->prepare("INSERT INTO videos (title, description, video_url, category, status, uploaded_by) VALUES (?, ?, ?, 'live_stream', ?, ?)");
            $stmt->execute([$title, $description, $video_url, $status, $_SESSION['user_id']]);
            header('Location: watch_live_stream.php');
            exit();
        } catch (PDOException $e) {
...
<head>
    ...
    <title>Watch Live Stream - ML HUB</title>
...
<body>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item active" href="watch_live_stream.php">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="text-center mb-4">
                        <i class="fas fa-broadcast-tower me-3"></i>Live Streams
                    </h1>
                    <form method="GET" class="d-flex gap-3">
                        <input type="text" name="search" class="form-control search-box" 
                               placeholder="Search live streams..." value="<?php echo htmlspecialchars($searchTerm); ?>">
    ...
    <div class="container my-5">
        ...
        <div class="admin-controls">
            <h4><i class="fas fa-plus-circle me-2"></i>Add New Live Stream</h4>
        ...
        <div class="row">
            <?php if (empty($videos)): ?>
                <div class="col-12 text-center py-5">
                    ...
                    <h4 class="text-muted">No live streams found</h4>
                    <p class="text-muted">
    ...
    <script>
        // Initialize chat for live stream page
